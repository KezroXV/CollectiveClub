...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-65LUJ2S2.js"), { isDevelopment } = await import("./local-L7K7ZZ6L.js"), oclif = await import("./lib-OSXFX3I2.js"), { ShopifyConfig } = await import("./custom-oclif-loader-FOUJADV6.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-ZDWJULQO.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-TSNDPDHE.js"), { moduleDirectory } = await import("./path-GB4VIEM6.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-WHQB5G4I.js.map
